...
const testIfDocumentIsFocused = (message, fn) => {
  if (document.hasFocus && document.hasFocus()) {
    ...
    it.skip(`${message} – document is not focused`);
  }
};

describe('components/TextInput', () => {
  it('prop "autoComplete"', () => {
    // on
  ...
  it('prop "onSelectionChange"', (done) => {
